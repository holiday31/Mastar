...
public class horse4 extends JFrame {
   ...
   public horse4() {
      ...
      JLabel lblNewLabel = new JLabel("가을의 전설");
      ...
      JLabel lblNewLabel_15 = new JLabel("호주");
      ...
      JLabel lblNewLabel_19 = new JLabel("30%");
      lblNewLabel_19.setHorizontalAlignment(SwingConstants.CENTER);
      lblNewLabel_19.setBounds(223, 241, 61, 16);
      contentPane.add(lblNewLabel_19);
      
      JLabel lblNewLabel_20 = new JLabel("40%");
      ...
      JLabel lblNewLabel_22 = new JLabel("2.5");
      lblNewLabel_22.setHorizontalAlignment(SwingConstants.CENTER);
      lblNewLabel_22.setBounds(93, 300, 61, 16);
      contentPane.add(lblNewLabel_22);
      
      JLabel lblNewLabel_23 = new JLabel("19.98");
